...
(function ($) {
  Drupal.color = {
    callback: function(context, settings, form, farb, height, width) {
      ...
      // Collapse the other fieldsets so more of the page is visible.
      $('#system-theme-settings fieldset').filter(':not(#color_scheme_form, .color-form fieldset)').addClass('collapsible').addClass('collapsed');
